...
![JS引擎线程的内存空间](../../../images/JS/语法/内存/JS引擎线程的内存空间.jpg)
...
![查看堆内存](../../../images/JS/语法/内存/查看堆内存.png)

点开 Student 类，选中任意一个实例，在下方的 Retainers 可以看出引用关系

* `@` 后跟数字可以视为堆内存地址，同样的堆地址意味着同一个对象

![查看堆内存对象引用关系](../../../images/JS/语法/内存/查看堆内存对象引用关系.png)
...
![查看堆内存增长情况](../../../images/JS/语法/内存/查看堆内存增长情况.png)
...
![堆内存快照](../../../images/JS/语法/内存/堆内存快照.png)

选中第二个快照，观察类型选择对比 Comparison，右侧选择对比第一个快照

![堆内存快照对比](../../../images/JS/语法/内存/堆内存快照对比.png)

可以明显看到，ArrayBuffer 增加了多少，从而可以知道 ArrayBuffer 导致了内存泄露

![堆内存快照对比结果](../../../images/JS/语法/内存/堆内存快照对比结果.png)
