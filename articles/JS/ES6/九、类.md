...
没有自己的 this，引用`距离最近的执行上下文的this`，不能使用 this 绑定对象，不能用作`对象方法、构造函数、原型方法`，但是可以用作`类的方法`，
...
![存取器属性](../../../images/JS/语法/类/存取器属性.png)
...
![不存在任何继承](../../../images/JS/语法/类/extends_不存在任何继承.png)
...
![继承Object类](../../../images/JS/语法/类/extends_继承Object类.png)
...
* 子类静态方法中，super 指向`父类`，只能调用父类上的属性和方法，调用的`父类方法内部this指向当前子类`，
