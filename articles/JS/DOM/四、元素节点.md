...
elem.dir                    //返回或设置当前元素的文字方向
elem.lang                   //返回或设置当前元素的语言
elem.hidden                 //返回或设置当前元素是否可见
元素内容：
elem.innerHTML              //返回或设置当前元素包含的HTML代码
elem.outerHTML              //返回或设置当前元素及其包含的HTML代码
元素客户区大小：
...
元素滚动大小：
elem.scrollTop              //返回或设置元素垂直滚动时上方不可见内容的垂直高度
elem.scrollLeft             //返回或设置元素水平滚动时左侧不可见内容的水平宽度
