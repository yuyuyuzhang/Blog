...
![重绘](https://github.com/yuyuyuzhang/Blog/blob/master/images/%E6%B5%8F%E8%A7%88%E5%99%A8/%E6%B5%8F%E8%A7%88%E5%99%A8%E7%9B%B8%E5%85%B3/%E9%87%8D%E7%BB%98.png)
...
V8 引擎将 JS 代码转换成 AST 抽象语法树分为词法分析和语法分析 2 个阶段
...
* **语法分析**：将词法单元转换成一个由元素逐级嵌套所组成的代表了程序语法结构的 `AST 抽象语法树`
...
* Babel 编译 ES6 语法：V8 引擎将 ES6 源码转换成 ES6 AST，Babel 将其转换成 ES5 AST，最后生成 ES5 源码
* JS 反编译
* ESlint 代码规范
* 代码高亮
* 关键词匹配
