...
![位置属性](../../images/DOM/Selection-位置属性(文本节点).png)
...
![位置属性](../../images/DOM/Selection-位置属性(元素节点).png)
...
![位置属性](../../images/DOM/range-位置属性(文本节点).png)
...
![位置属性](../../images/DOM/range-位置属性(元素节点).png)
...
![填充简单范围](../../images/DOM/range-填充简单范围.png)
...
![填充复杂范围](../../images/DOM/range-填充复杂范围.png)
