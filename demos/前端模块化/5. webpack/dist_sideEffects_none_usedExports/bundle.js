...
// Tree-shaking
document.body.appendChild(Object(_component_js__WEBPACK_IMPORTED_MODULE_4__[/* Button */ "a"])())

// sideEffects
// 虽然只希望载入 Link 模块，但实际上载入的是 common/index.js 文件，
// index.js 文件中又载入了 common 目录下的所有组件模块，这会导致所有组件模块都被加载执行
document.body.appendChild(Object(_commons_index_js__WEBPACK_IMPORTED_MODULE_5__[/* Link */ "a"])())
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = ("./fonts/TJS.ttf");
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "a", function() { return _link__WEBPACK_IMPORTED_MODULE_1__["a"]; });
